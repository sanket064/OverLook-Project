...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-12  background-color">
      <h1 class="h2-subhead pt-5 new-padding ">Welcome to the Vanarts <?php echo ($_SESSION['user_role']); ?> Portal, <?php echo ($_SESSION['first_name']); ?></h1>
    </div>
    <?php 
