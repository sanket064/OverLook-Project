...
<table class="table table-hover table-dark">
  ...
  <tbody>
    ...
    foreach($this->arrAssignments as $assignments) {
        ...
        ?>
        <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#product_view<?=$assignments['student_assignment_id']?>"><i class="fa fa-search"></i> Quick View</button></td>
        <!-- <?php
    ...
    <div class="modal-content">
      ...
      <?php
         ...
         if($assignments['student_assignment_comments'] === NULL) {
            echo "<h1 class='bg-warning'>Pending</h1>";
        } else if($assignments['student_assignment_marks'] < 50){
            echo "<h1 class='bg-danger'>".$assignments['student_assignment_comments']."</h1>";
        } else if($assignments['student_assignment_marks'] > 50){
            echo "<h1 class='bg-success'>".$assignments['student_assignment_comments']."</h1>";
        }
         ?>
      </div>
    </div>
