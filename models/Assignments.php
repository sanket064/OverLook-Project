...
Class Assignments extends Model {
   ...
   // ALL STUDENT RELATED MODELS BELOW THIS LINE -------------------------------------------------------------------------------------
    ...
    student_assignment.student_assignment_assignment_id,
	...
	LEFT JOIN assignments ON assignments.assignment_id = student_assignment.student_assignment_student_id
	WHERE
		student_assignment.student_assignment_teacher = '$teacher_name'";
	$results = mysqli_query(ConnectToDb::con(), $sql);
