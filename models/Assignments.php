...
Class Assignments extends Model {
   ...
   // ALL STUDENT RELATED MODELS BELOW THIS LINE -------------------------------------------------------------------------------------
	public static function getAllStudentAssignments()
	{
		...
		assignments.assignment_teacher_name, assignments.assignment_class_id, 
		assignments.assignment_term, 
		assignments.assignment_credits, 
		assignments.assignment_date_due, 
		classes.classes_id, 
		classes.classes_name, student_assignment.student_assignment_id, student_assignment.student_assignment_marks, student_assignment.student_assignment_comments, student_assignment.student_assignment_date_submitted FROM users 
